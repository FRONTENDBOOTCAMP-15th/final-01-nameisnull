        ...
        <div className="flex flex-col mt-27.5">
          ...
          <div className="mt-1.5 pt-1.5 flex gap-3 overflow-x-auto pb-1.5">
            ...
            >
              ...
              <span className="text-[11px] text-[#8A8F99]"></span>
              <input
                type="file"
                id="profileUpload"
                className="hidden"
            ...
            <div /* key={index} */ className="relative w-21 h-21 shrink-0">
              <div className="w-full h-full overflow-hidden rounded-lg bg-[#E5E5EA]">
                ...
                <img className="w-full h-full object-cover border border-[#e5e5ea] rounded-lg " />
              </div>
              <button
                type="button"
          ...
          <div>
            ...
            <div className="flex gap-3.75 mt-1.5">
              <button
                ...
                className={`flex-1 px-[63px] py-[17px] rounded-lg text-[15px] ${
                  petType === 'dog'
